...
import com.example.loginapp.Mapas.MapaEstado;
import com.example.loginapp.R;
import com.example.loginapp.SetGet_Consultas.estados;
...
public class SpinnerEstado extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue= Volley.newRequestQueue(SpinnerEstado.this);
        progressDialog=new ProgressDialog(SpinnerEstado.this);
