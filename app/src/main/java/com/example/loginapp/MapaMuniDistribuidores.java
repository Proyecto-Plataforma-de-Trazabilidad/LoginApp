...
public class MapaMuniDistribuidores extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener{
    ...
    String httpURI="https://proyectoapejal.000webhostapp.com/agenda/consulMuniDistri.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_muni_distribuidores);
        ...
        requestQueue= Volley.newRequestQueue(MapaMuniDistribuidores.this);
        //Indicar dónde se ejecutará progressdialog
        progressDialog=new ProgressDialog(MapaMuniDistribuidores.this);
