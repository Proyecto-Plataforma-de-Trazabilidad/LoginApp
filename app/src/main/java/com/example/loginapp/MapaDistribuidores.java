...
public class MapaDistribuidores extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_distribuidores);

        requestQueue= Volley.newRequestQueue(MapaDistribuidores.this);
        ...
        btnvolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent volver= new Intent(MapaDistribuidores.this,Index.class);
