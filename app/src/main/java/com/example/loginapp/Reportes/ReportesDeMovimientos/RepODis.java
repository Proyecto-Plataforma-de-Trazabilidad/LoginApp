...
public class RepODis extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rep_odis);
        cliente = new AsyncHttpClient();
        cbodis = (Spinner) findViewById(R.id.cbodis);
        llenarspinner();
        ...
        requestQueue = Volley.newRequestQueue(RepODis.this);
        progressDialog = new ProgressDialog(RepODis.this);
    ...
    private void cargarspinner(String respuesta) {
        ...
        try {
            ...
            cbodis.setAdapter(a);
            cbodis.setOnItemSelectedListener(this);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        dis = parent.getSelectedItem().toString();
    ...
    //--------consulta a servidor-------------------
    private void Consultar(String dis,String fi,String ff) {
                ...
                try{
                    ...
                    for (int i = 0; i < result.length(); ) {
                        ...
                        if(n=="null" || c=="0"){
                            ...
                            int C= Integer.parseInt(jsonObject.getString("TotalE"));
                            //agregamos datos al arreglo
                            valores[i]=C;
                            etiquetas[i]=n;
                        }
