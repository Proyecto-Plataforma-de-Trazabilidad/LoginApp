...
public class Rep1Pro extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rep1_pro);

        requestQueue= Volley.newRequestQueue(Rep1Pro.this);
        progressDialog=new ProgressDialog(Rep1Pro.this);

        barras2=findViewById(R.id.ProE);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, httpURI, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    //enlazamos
                    BarChart barChart=findViewById(R.id.ProG);
                    //creamos arreglo
                    ...
                    for (int i = 0; i < result.length(); ) {
                        ...
                        int ori= Integer.parseInt(jsonObject.getString("TotalP"));
                        //agregamos datos al arreglo
                        visitor.add(new BarEntry(1,ori));
                        String etiqueta="Total Productores";
                        //DataSet
    ...
    private void creargrafico(){
        barras2=(BarChart)getSameChart(barras2,"Productores",Color.BLACK,Color.WHITE,2000);
    ...
    private void graficoMunicipios(String barrac) {
        barras3 = (BarChart) findViewById(R.id.ProM);
