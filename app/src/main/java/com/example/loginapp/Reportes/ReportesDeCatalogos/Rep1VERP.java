...
public class Rep1VERP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rep1_verp);

        requestQueue= Volley.newRequestQueue(Rep1VERP.this);
        progressDialog=new ProgressDialog(Rep1VERP.this);

        barras2=findViewById(R.id.ERPV);
        consulta();
    }
    ...
    private void consulta() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, httpURI, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < result.length(); ) {
                        ...
                        int valor = Integer.parseInt(jsonObject.getString("TotalVE"));
            ...
            protected Map<String,String> getParams(){
                ...
                parametros.put("opcion","Rep1VERP");
                return parametros;
            }
        };
