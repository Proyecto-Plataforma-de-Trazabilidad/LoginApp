...
public class Rep1VMun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rep1_vmun);

        requestQueue= Volley.newRequestQueue(Rep1VMun.this);
        progressDialog=new ProgressDialog(Rep1VMun.this);

        barras2=findViewById(R.id.MUV);
        consulta();
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < result.length(); ) {
                        ...
                        int valor = Integer.parseInt(jsonObject.getString("TotalVMu"));
                        String nom = jsonObject.getString("NombreLugar");
                        etiquetas[i]=nom;
                        valores[i]=valor;
    ...
    private void creargrafico(){
        barras2=(BarChart)getSameChart(barras2,"Vehiculos", Color.BLACK,Color.WHITE,2000);
