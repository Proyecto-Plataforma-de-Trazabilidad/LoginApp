...
public class Rep1VDis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rep1_vdis);

        requestQueue= Volley.newRequestQueue(Rep1VDis.this);
        progressDialog=new ProgressDialog(Rep1VDis.this);


        barras2=findViewById(R.id.DisV);
        VDis();
    }
    private void VDis() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < result.length(); ) {
                        ...
                        int valor = Integer.parseInt(jsonObject.getString("TotalVD"));
