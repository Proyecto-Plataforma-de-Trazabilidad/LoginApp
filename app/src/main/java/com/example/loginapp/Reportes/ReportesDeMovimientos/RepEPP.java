...
public class RepEPP extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rep_epp);
        ...
        requestQueue = Volley.newRequestQueue(RepEPP.this);
        progressDialog = new ProgressDialog(RepEPP.this);
