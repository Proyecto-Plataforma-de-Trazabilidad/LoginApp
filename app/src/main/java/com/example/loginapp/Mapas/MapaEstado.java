...
import com.example.loginapp.Catalogos_muni.SpinnerEstado;
...
public class MapaEstado extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    String httpURI="https://proyectoapejal.000webhostapp.com/agenda/marcadoresxEstado.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dato= bundle.getString("Estado");//dato rescata el string del identificador(osea el valor del estado seleccionado)
        ...
        requestQueue= Volley.newRequestQueue(MapaEstado.this);
        //Indicar dónde se ejecutará progressdialog
        progressDialog=new ProgressDialog(MapaEstado.this);
    ...
    private void TraerMarcadores(){//aqui consulta los datos en la BD
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, httpURI,
            ...
            protected Map<String,String> getParams(){
                ...
                parametros.put("Estado",dato);//dato es el valor que recogio el valor del combo
                return parametros;
            }
        };
