package com.example.loginapp.Movimientos.CAT.Entregas;
...
public class ConsuEnPr_CAT extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emisor = MainActivity.obtenerusuario(ConsuEnPr_CAT.this, MainActivity.m);
        ...
        requestQueue = Volley.newRequestQueue(ConsuEnPr_CAT.this);
        progressDialog = new ProgressDialog(ConsuEnPr_CAT.this);
                ...
                try {
                    ...
                    for (int i = 0; i < result.length();i++ ) {
                        ...
                        boton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(ConsuEnPr_CAT.this, "pertenesco a "+v.getTag(), Toast.LENGTH_SHORT).show();
