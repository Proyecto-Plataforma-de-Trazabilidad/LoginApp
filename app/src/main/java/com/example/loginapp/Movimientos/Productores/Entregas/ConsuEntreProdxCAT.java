...
public class ConsuEntreProdxCAT extends DrawerBaseActivity implements AdapterView.OnItemSelectedListener {
    ...
    String emisor;
    ActivityConsuEntreProdxCatBinding activityConsuEntreProdxCatBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_consu_entre_prodx_cat);

        //aqui va lo del menu
        activityConsuEntreProdxCatBinding= ActivityConsuEntreProdxCatBinding.inflate(getLayoutInflater());
        setContentView(activityConsuEntreProdxCatBinding.getRoot());
        allowActivityTitle("Entregas/CAT");

        tbtE = findViewById(R.id.tablaEntregas);
        tbtDetE = findViewById(R.id.tabladetEn);
        ///variables sesion correo
        emisor = MainActivity.obtenerusuario(ConsuEntreProdxCAT.this, MainActivity.m);


        cliente = new AsyncHttpClient();
        cbousuario = (Spinner) findViewById(R.id.cboCAT);
        llenarspinner();

        requestQueue = Volley.newRequestQueue(ConsuEntreProdxCAT.this);
        progressDialog = new ProgressDialog(ConsuEntreProdxCAT.this);
    ...
    private void llenarspinner() {
        String url = "https://campolimpiojal.com/android/cboEntregasCat.php";
                ...
                try {
                    ...
                    for (int i = 0; i < result.length();i++ ) {
                        ...
                        boton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(ConsuEntreProdxCAT.this, "pertenesco a "+v.getTag(), Toast.LENGTH_SHORT).show();
