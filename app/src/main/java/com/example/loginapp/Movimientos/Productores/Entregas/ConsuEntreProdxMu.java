...
public class ConsuEntreProdxMu extends AppCompatActivity  implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emisor = MainActivity.obtenerusuario(ConsuEntreProdxMu.this, MainActivity.m);


        cliente = new AsyncHttpClient();
        cbousuario = (Spinner) findViewById(R.id.cboMuni);
        llenarspinner();

        requestQueue = Volley.newRequestQueue(ConsuEntreProdxMu.this);
        progressDialog = new ProgressDialog(ConsuEntreProdxMu.this);
                ...
                try {
                    ...
                    for (int i = 0; i < result.length();i++ ) {
                        ...
                        boton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(ConsuEntreProdxMu.this, "pertenesco a "+v.getTag(), Toast.LENGTH_SHORT).show();
