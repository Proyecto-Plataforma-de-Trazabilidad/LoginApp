...
public class ConsuEntreProdxDist extends DrawerBaseActivity implements AdapterView.OnItemSelectedListener {
    ...
    ActivityConsuEntreProdxDistBinding activityConsuEntreProdxDistBinding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //aqui va lo del menu
        activityConsuEntreProdxDistBinding= ActivityConsuEntreProdxDistBinding.inflate(getLayoutInflater());
        setContentView(activityConsuEntreProdxDistBinding.getRoot());
        ...
        emisor= MainActivity.obtenerusuario(ConsuEntreProdxDist.this,MainActivity.m);

        cliente=new AsyncHttpClient();
        cbousuario =(Spinner) findViewById(R.id.cbodistri);
        llenarspinner();

        requestQueue= Volley.newRequestQueue(ConsuEntreProdxDist.this);
        progressDialog=new ProgressDialog(ConsuEntreProdxDist.this);
                ...
                try {
                    ...
                    for (int i = 0; i < result.length();i++ ) {
                        ...
                        boton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(ConsuEntreProdxDist.this, "pertenesco a "+v.getTag(), Toast.LENGTH_SHORT).show();
