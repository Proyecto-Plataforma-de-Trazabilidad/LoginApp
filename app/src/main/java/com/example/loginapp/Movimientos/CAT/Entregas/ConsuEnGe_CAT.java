...
public class ConsuEnGe_CAT extends DrawerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //variables sesion nombre
         emisorname = Index.obtenerrol(ConsuEnGe_CAT.this, Index.no);

        TextView nom=findViewById(R.id.cat);
        nom.setText(Html.fromHtml("<b>CAT: </b>"+emisorname));//nombre del usuario

        tbtE=findViewById(R.id.tablaEntregas);
        tbtDetE=findViewById(R.id.tabladetEn);

        requestQueue= Volley.newRequestQueue(ConsuEnGe_CAT.this);
        progressDialog=new ProgressDialog(ConsuEnGe_CAT.this);
