...
import com.example.loginapp.databinding.ActivityEntreErpAdmiBinding;
import com.example.loginapp.databinding.ActivityEntreMuniAdmiBinding;
...
public class EntreErpAdmi extends DrawerBaseActivity implements AdapterView.OnItemSelectedListener  {
    ActivityEntreErpAdmiBinding activityEntreErpAdmiBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entre_erp_admi);

        //aqui va lo del menu
        activityEntreErpAdmiBinding= ActivityEntreErpAdmiBinding.inflate(getLayoutInflater());
        setContentView(activityEntreErpAdmiBinding.getRoot());
        allowActivityTitle("Entregas/ERP");
        ...
        requestQueue= Volley.newRequestQueue(EntreErpAdmi.this);
        progressDialog=new ProgressDialog(EntreErpAdmi.this);
