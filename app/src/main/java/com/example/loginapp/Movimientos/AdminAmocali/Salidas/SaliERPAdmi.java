...
import com.example.loginapp.databinding.ActivitySaliErpadmiBinding;
...
public class SaliERPAdmi extends DrawerBaseActivity implements AdapterView.OnItemSelectedListener {
    ActivitySaliErpadmiBinding activitySaliErpadmiBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sali_erpadmi);

        //aqui va lo del menu
        activitySaliErpadmiBinding= ActivitySaliErpadmiBinding.inflate(getLayoutInflater());
        setContentView(activitySaliErpadmiBinding.getRoot());
        ...
        requestQueue= Volley.newRequestQueue(SaliERPAdmi.this);
        progressDialog=new ProgressDialog(SaliERPAdmi.this);
