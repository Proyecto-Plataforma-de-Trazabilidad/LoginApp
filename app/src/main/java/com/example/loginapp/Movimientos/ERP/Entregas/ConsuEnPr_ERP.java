...
public class ConsuEnPr_ERP extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emisor = MainActivity.obtenerusuario(ConsuEnPr_ERP.this, MainActivity.m);
        ...
        requestQueue = Volley.newRequestQueue(ConsuEnPr_ERP.this);
        progressDialog = new ProgressDialog(ConsuEnPr_ERP.this);
                ...
                try {
                    ...
                    for (int i = 0; i < result.length();i++ ) {
                        ...
                        boton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(ConsuEnPr_ERP.this, "pertenesco a "+v.getTag(), Toast.LENGTH_SHORT).show();
