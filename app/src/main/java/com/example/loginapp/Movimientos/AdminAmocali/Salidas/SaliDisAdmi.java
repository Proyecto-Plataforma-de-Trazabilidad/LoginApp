...
public class SaliDisAdmi extends DrawerBaseActivity implements AdapterView.OnItemSelectedListener  {
    ActivitySaliDisAdmiBinding activitySaliDisAdmiBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sali_dis_admi);

        //aqui va lo del menu
        activitySaliDisAdmiBinding= ActivitySaliDisAdmiBinding.inflate(getLayoutInflater());
        setContentView(activitySaliDisAdmiBinding.getRoot());
        allowActivityTitle("Salidas/Distribuidor");
        ...
        requestQueue= Volley.newRequestQueue(SaliDisAdmi.this);
        progressDialog=new ProgressDialog(SaliDisAdmi.this);
