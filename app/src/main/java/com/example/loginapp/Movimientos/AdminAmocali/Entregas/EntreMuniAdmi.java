...
public class EntreMuniAdmi  extends DrawerBaseActivity implements AdapterView.OnItemSelectedListener {
    ActivityEntreMuniAdmiBinding activityEntreMuniAdmiBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entre_muni_admi);

        //aqui va lo del menu
        activityEntreMuniAdmiBinding= ActivityEntreMuniAdmiBinding.inflate(getLayoutInflater());
        setContentView(activityEntreMuniAdmiBinding.getRoot());
        ...
        requestQueue= Volley.newRequestQueue(EntreMuniAdmi.this);
        progressDialog=new ProgressDialog(EntreMuniAdmi.this);
